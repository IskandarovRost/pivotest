...
public class PivotestTestContainer extends TestContainer {

    public PivotestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/pivotest/app.properties",
    ...
    public static class Common extends PivotestTestContainer {

        public static final PivotestTestContainer.Common INSTANCE = new PivotestTestContainer.Common();
